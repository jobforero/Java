...
public class Main {
    ...
    private static void agregarComida() {
        ...
        System.out.print("¿Es picante? (S/N): ");
    ...
    private static void crearCombo() {
        ...
        if (nuevoCombo != null) {
            System.out.println("\n¿Desea agregar productos al combo ahora? (S/N)");
    ...
    private static void agregarProductosACombo(Combo combo) {
        ...
        while (continuar) {
            gestorProductos.mostrarCatalogo();
            System.out.print("Ingrese el índice del producto (o -1 para terminar): ");
    ...
    private static void menuFacturas() {
        ...
        while (!volver) {
            ...
            System.out.println("  4. Ver factura específica");
            System.out.println("  5. Volver al menú principal");
            System.out.println("════════════════════════════════════════════════");
            System.out.print("Seleccione una opción: ");
    ...
    private static void generarFacturaPedidoExistente() {
        ...
        System.out.print("Ingrese el índice del pedido: ");
        int indice = Validaciones.validarEnteroPositivo(scanner);
    ...
    private static void verFacturaEspecifica() {
        ...
        System.out.print("Ingrese el índice de la factura: ");
        int indice = Validaciones.validarEnteroPositivo(scanner);
    ...
    private static void mostrarReportes() {
        ...
        System.out.println("📋 Total de productos: " + gestorProductos.cantidadProductos());
        System.out.println("🛒 Total de pedidos: " + gestorPedidos.cantidadPedidos());
        System.out.println("💵 Total de facturas: " + gestorFacturas.cantidadFacturas());
